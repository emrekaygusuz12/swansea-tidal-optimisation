...
public final class Lagoon {
    ...
    private static final double TURBINE_DISCHARGE_COEFFICIENT = 1.36; 
    ...
    private static final double TOTAL_CAPITAL_COST = 1_327_000_000.0; 
     ...
     * 
     * The orientation determines when turbines can generate power
     * relative to the tidal cycle phases.
     */
